...
export default function SubscribeGate({ returning = false, signedOut = false }: SubscribeGateProps) {
  ...
  return (
    <div className="relative isolate min-h-full md:h-full flex flex-col items-center text-center px-4 pt-12 sm:pt-16 pb-16 gap-10 sm:gap-12 md:overflow-y-auto">
      {/* Hero */}
