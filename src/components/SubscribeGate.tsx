...
const FEATURE_CARDS = [
  ...
  },
  {
    ...
    body: 'Recreation.gov campgrounds nationwide — national parks, forests, and lakes — plus state parks in 33 states — including California, Texas, Arizona, Florida, New York, Oregon, Utah, Nevada, Ohio, Virginia, Illinois, Wyoming, Pennsylvania, Tennessee, and more, with additional states rolling out. 5,500+ campgrounds and counting.',
    badge: null as string | null,
  },
];
