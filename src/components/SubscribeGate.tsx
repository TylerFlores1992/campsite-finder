...
const FEATURE_CARDS = [
  ...
  },
  {
    ...
    body: 'Recreation.gov campgrounds nationwide — national parks, forests, and lakes — plus California, Arizona, Minnesota, and Missouri state parks, with more rolling out. 5,000+ campgrounds and counting.',
    badge: null,
  },
];
