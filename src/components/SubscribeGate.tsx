...
const FEATURE_CARDS = [
  ...
  },
  {
    ...
    body: 'Recreation.gov campgrounds nationwide — national parks, forests, and lakes — plus California, Arizona, Florida, Minnesota, and Missouri state parks, with more rolling out. 5,500+ campgrounds and counting.',
    badge: null,
  },
];
